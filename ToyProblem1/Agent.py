...
class Agent:
    ...
    def __init__(self, nb_devices, lr=4e-3,  gamma=0.9):
        ...
        self.Critic = Critic(lr, nb_devices*5, nb_devices, 50)
    ...
    def get_minibatch(self, state, batch_size):
        ...
        print(actions.shape)
        print(actions)
        critic_state = [state + action for action in actions] #strap the actions at the end of the state to then feed into the critc net
        return critic_state
